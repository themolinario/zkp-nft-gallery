...
const initialAssets: NFTAsset[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/persistence-memory.jpg',
    description: 'The melting clocks of surrealism',
    position: [-4, 0, -6],
    isUnlocked: true, // Pre-unlocked for demo
    contractAddress: '0x495f947276749ce646f68ac8c248420045cb7b5e',
    tokenId: '11111',
    collection: 'Surreal Visions',
    rarity: 'rare',
    ownershipHash: 'verified_hash',
    attributes: [
      { trait_type: 'Style', value: 'Surrealism', rarity_score: 88 },
      { trait_type: 'Dream Level', value: 'Lucid', rarity_score: 92 },
      { trait_type: 'Time Distortion', value: 'Extreme', rarity_score: 95 }
    ]
  },
  {
    id: '5',
